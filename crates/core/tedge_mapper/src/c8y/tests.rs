...
pub mod mapper_tests {
    ...
    use crate::c8y::converter::get_child_id_from_measurement_topic;
    ...
    async fn mapper_publishes_a_software_list_request() {
        ...
        mqtt_tests::assert_received_all_expected(&mut messages, TEST_TIMEOUT_MS, &[r#"{"id":"#])
            .await;
    ...
    async fn c8y_mapper_alarm_empty_payload() {
        ...
        broker
            .publish_with_opts(
                "tedge/alarms/major/empty_pressure_alarm",
                "{}",
                mqtt_channel::QoS::AtLeastOnce,
                true,
            )
